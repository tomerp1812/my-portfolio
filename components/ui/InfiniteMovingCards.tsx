...
export const InfiniteMovingCards = ({
    ...
    return (
        ...
        >
            ...
            border border-b-0 flex-shrink-0 border-slate-800 p-5 md:p-16 md:w-[60vw]"
                        style={{
                            background: 'rgb(2,0,36)',
                            backgroundColor:
                                'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(114,114,138,1) 26%, \
                        ...
                        <blockquote>
                            ...
                            <div className="relative z-20 mt-6 flex flex-row items-center">
                                <span className="flex flex-col gap-1">
                                    <div className="me-3">
                                        <img src="/dan.png" alt="profile" className="w-10 h-10 rounded-full"/>
                                    </div>
