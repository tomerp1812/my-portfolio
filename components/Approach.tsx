    ...
    return (
       ...
       gap-4">
                <Card title="Planning & Strategy"
                    ...
                    description="My approach to planning and strategy is to make sure that I understand the job,
                    and the problem that needs to be solved. I will then create a plan that will help me to solve the 
                ...
                <Card title="Development"
                    ...
                    description="My approach to develpment is to work with the plan in mind.
                    If the plan is good, then smooth sailing. If the plan is bad, then I will have to make changes to the plan,
                ...
                <Card title="Deployment & feedback"
                    icon={<AceternityIcon order="Phase 3" />}
                    description="My approach to deployment is to make sure that the project is working as intended,
                    I will then deploy the project. And ask for feedback, and make changed if needed."
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
    ...
    return (
        <div
            ...
            className="border border-black/[0.2] group/canvas-card flex items-center \
             ...
             relative lg:h-[35rem] rounded-3xl"
        >
        ...
        <div>
            <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center \
                 justify-center rounded-full bg-slate-950 px-5 py-2 text-2xl font-bold \
